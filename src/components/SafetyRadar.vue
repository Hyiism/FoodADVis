...
const analysis = computed(() => {
  ...
  return {
    ...
    farmer: { name: farmerName, vol: farmerVol, desc: farmerVol > 10 ? 'High Frequency' : 'Low Frequency' },
    market: { name: marketName, vol: marketVol, desc: marketVol > 50 ? 'Major Hub' : 'Local Point' },
